...
//#define FIREBASE_HOST  "https://dht11-dfe23-default-rtdb.firebaseio.com/" 
//#define FIREBASE_AUTH "Y2WeksQs7VxlM22hMd8sMrNw2atdEmvSNFYan2Jz"
#define FIREBASE_HOST "https://project4-b9539-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "rfbnjipTWgb75nCHHQSGHCOC4QaqXP7uH8RagLol"

#define WIFI_SSID "MinhDoanh"   
#define WIFI_PASSWORD "doanh2002"
...
void loop() 
{
   ...
   float hm = dht.readHumidity();// đo độ ẩm
   float Tm = dht.readTemperature();//đo nhiệt độ
